<?php
// В массив А(N,М) вставить одномерный массив В(N),
// расположив его  перед  последним  столбцом,  содержащим  нулевой  элемент.
//  Если  такого  столбца не окажется, то вставить массив В(N) после  последнего столбца.
